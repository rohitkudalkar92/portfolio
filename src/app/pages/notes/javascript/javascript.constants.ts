export const JAVASCRIPT_CODE_EXAMPLES = {
  variables: `// var - function scoped, hoisted
var x = 10;
if (true) {
...
console.log(Array.isArray(arr)); // true`,
  ...
  functions: `// Function Declaration (hoisted)
function greet(name) {
  return \`Hello, \${name}\`;
}
...
async function getData() {
  ...
  arrayMethods: `const numbers = [1, 2, 3, 4, 5];
...
function greet({ name, age }) {
  ...
  spreadRest: `// Spread - expand elements
const arr1 = [1, 2, 3];
...
const boundGreet = greet.bind(person);`,
  ...
  prototypes: `// Constructor function
...
class Person {}`,
  ...
  objectMethods: `const obj = { a: 1, b: 2, c: 3 };
...
// Error types: Error, TypeError, ReferenceError, SyntaxError`,
  ...
  json: `const user = { name: 'John', age: 30 };
...
// JSON.stringify(obj); // Error: circular reference`,
  ...
  setTimeoutInterval: `// setTimeout - run once after delay
...
function repeat() {
  ...
  domManipulation: `// Select elements
...
el.remove();`,
  ...
  eventHandling: `// Add event listener
...
if (localStorage.getItem('key') !== null) {
  ...
  regularExpressions: `// Create regex
...
const global = /a/g;`,
  ...
  higherOrderFunctions: `// Higher-Order Functions - functions that take or return functions
